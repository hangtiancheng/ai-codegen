...
export function AdminChatTable({ messages, onViewChat }: AdminChatTableProps): ReactNode {
  return (
    <DataTable
      records={messages}
    ...
    },
    {
      ...
      render: (message) => (
        <details className="max-w-lg">
          <summary className="text-foreground cursor-pointer truncate">{message.message}</summary>
