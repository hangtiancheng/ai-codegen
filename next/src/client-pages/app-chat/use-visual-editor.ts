...
import { type VisualEditorElementInfo, visualEditorIncomingMessageSchema } from "@/shared/schemas";
...
export function useVisualEditor(): VisualEditorState {
  ...
  const [selectedElement, setSelectedElement] = useState<VisualEditorElementInfo>();
