...
export function MessageRow({ index, measureElement, message, offset }: MessageRowProps): ReactNode {
  ...
  return (
    ...
    >
      <div
        className={cn("flex gap-3", isUser ? "flex-row-reverse justify-start" : "justify-start")}
      >
        <div
          className={cn(
        ...
        <div
          className={cn(
            ...
            isUser ? "bg-primary/10 rounded-tr-sm" : "bg-background rounded-tl-sm",
          )}
        >
          {message.loading ? (
