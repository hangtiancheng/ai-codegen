...
export function ChatHeader({ app, canManage, onDetails, onEdit }: ChatHeaderProps): ReactNode {
  return (
    <header className="border-border bg-card flex flex-wrap items-center justify-between gap-3 rounded-2xl border p-4 shadow-sm">
      <div className="min-w-0">
        <h1 className="text-foreground truncate text-xl font-semibold">{app.appName}</h1>
