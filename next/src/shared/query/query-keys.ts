...
export const queryKeys = {
  ...
  app: {
    ...
    awesomeList: (params: AppQueryRequest) => ["app", "awesome", params] as const,
  ...
  chatHistory: {
    ...
    byAppPaged: (appId: AppId, params: { pageSize: number; lastCreateTime?: string }) =>
      ["chatHistory", "app", appId, params] as const,
    adminList: (params: ChatHistoryQueryRequest) => ["chatHistory", "admin", params] as const,
  },
} as const;
