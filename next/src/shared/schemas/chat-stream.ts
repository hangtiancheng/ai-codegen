...
export type ChatStreamMessagePayload = z.infer<typeof chatStreamMessagePayloadSchema>;
...
export type ChatStreamBusinessErrorPayload = z.infer<typeof chatStreamBusinessErrorPayloadSchema>;
