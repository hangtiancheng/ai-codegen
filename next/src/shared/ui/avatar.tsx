...
export function Avatar({ src, name, size = "md", className }: AvatarProps): ReactNode {
  ...
  return (
    <span
      className={cn(
        "border-primary/10 bg-primary/10 text-primary relative inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full border font-semibold",
        sizeClass[size],
        className,
      )}
      role="img"
