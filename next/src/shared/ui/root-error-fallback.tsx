...
export function RootErrorFallback({ error }: RootErrorFallbackProps): ReactNode {
  return (
    <div role="alert" className="bg-background flex h-full w-full items-center justify-center p-8">
