...
export async function getAppById(id: AppId): Promise<AppVo> {
  return httpClient.request({ method: "GET", url: "app/get/vo", query: { id } }, appVoSchema);
}
...
export async function listAwesomeAppPage(body: AppQueryRequest): Promise<AppPage> {
  return httpClient.request(
    {
      method: "POST",
...
export async function listAdminAppPage(body: AppQueryRequest): Promise<AppPage> {
  return httpClient.request(
    {
      method: "POST",
...
export async function updateAppByAdmin(body: AppAdminUpdateRequest): Promise<boolean> {
  return httpClient.request(
    {
      method: "POST",
...
export async function deleteAppByAdmin(body: AppDeleteRequest): Promise<boolean> {
  return httpClient.request(
    {
      method: "POST",
