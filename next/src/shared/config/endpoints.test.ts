...
describe("resolveEndpointPaths", () => {
  it("returns the canonical endpoint paths", () => {
    ...
    expect(endpoints.appChatHistory(appIdSchema.parse(10))).toBe("chat-history/app/10");
    expect(endpoints.adminChatHistoryList).toBe("chat-history/admin/list/page/vo");
